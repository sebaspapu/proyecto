...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="admin.php">Hola Admin</a>
    </div>
    <ul class="nav navbar-nav">
      <li class="active"><a href="admin.php">Home</a></li>
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">CRUD usuarios <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="/proyecto/src/crud/index.php">CRUD</a></li>
        </ul>
      </li>
